    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" valign="top"><span class="left_bt">感谢您使用 QuickSend 网站管理系统程序</span><br>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您可以在此<span class="left_ts">添加配送点</span>。</span><span class="left_txt"><br>
</span></td>
        <td width="7%">&nbsp;</td>
...
mainTable.tBodies[n].style.display="block";
                ...
                <!--HTML部分-->
                <s:form action="updateSaveDispatchSiteAction">
                	<s:textfield key="NO" label="编号" value="%{NO}" readonly="true"/>
            		<s:textfield key="name" label="名称" value="%{name}"> </s:textfield>
            		<s:textfield key="address" label="地址" value="%{address}"/>
            		<s:textfield key="level" label="等级" value="%{level}"/>
                <br>
                <s:submit name="保存修改" value="保存修改"></s:submit>
              </s:form>
			<a href="<s:url action="viewAllDispatchSiteAction"/>">详细信息</a>
          </td>
        <td>&nbsp;</td>
